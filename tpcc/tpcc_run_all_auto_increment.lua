...
--                       :o_ol_cnt, :o_all_local);
  ...
  con:query(([[INSERT INTO orders%d
                           (id, o_id, o_d_id, o_w_id, o_c_id,  o_entry_d, o_ol_cnt, o_all_local)
                    VALUES (null, %d,%d,%d,%d,NOW(),%d,%d)]]):
                    format(table_num, d_next_o_id, d_id, w_id, c_id, ol_cnt, all_local))

-- INSERT INTO new_orders (no_o_id, no_d_id, no_w_id)
--    VALUES (:o_id,:d_id,:w_id); */

  con:query(([[INSERT INTO new_orders%d (id, no_o_id, no_d_id, no_w_id)
                    VALUES (null, %d,%d,%d)]]):
...
--		:ol_dist_info);
	...
	con:query(([[INSERT INTO order_line%d
                                 (id, ol_o_id, ol_d_id, ol_w_id, ol_number, ol_i_id, ol_supply_w_id, ol_quantity, ol_amount, ol_dist_info)
	                  VALUES (null, %d,%d,%d,%d,%d,%d,%d,%d,'%s')]]):
...
--			       :h_amount, :h_data);*/
  ...
  con:query(([[INSERT INTO history%d
                           (id, h_c_d_id, h_c_w_id, h_c_id, h_d_id,  h_w_id, h_date, h_amount, h_data)
                    VALUES (null, %d,%d,%d,%d,%d,NOW(),%d,'%s')]])
